...
namespace app
{
	namespace credits
	{
		...
		static char text5[] = "ASTEROIDS V 1.1";
		static char text6[] = "Sonidos realizados con Bfxr";
		static char text7[] = "Imagenes y assets:";
		static char text8[] = "-'Blue Pink and White Andromeda Galaxy Way', Autor: Miriam Espacio, https://www.pexels.com/photo/sky-space-milky-way-stars-110854/";
		static char text9[] = "-'Red and Orange Galaxy Illustration', Pixabay, https://www.pexels.com/photo/sky-space-telescope-universe-41951/";
		static char text10[] = "-La nave, los asteroides y el disparo fueron creados con Adobe Illustrator y las imagenes modificadas con Adobe Photoshop";
